        ...
        <div className="flex items-center justify-between px-6 py-4 bg-slate-950/60 border-b border-slate-800">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                ...
                <span className="text-xs font-mono text-slate-400">({modelId})</span>
              </h2>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white text-xs font-semibold flex items-center space-x-1.5 border border-slate-700 transition"
            ...
            <button
              ...
              disabled={loading || !passport}
              className="px-3 py-1.5 rounded-lg bg-cyan-600/20 hover:bg-cyan-600/30 text-cyan-300 text-xs font-semibold flex items-center space-x-1.5 border border-cyan-500/30 transition"
          ...
          {[
            ...
            return (
              <button
                ...
                className={`py-3 px-3.5 font-semibold flex items-center space-x-2 border-b-2 transition ${
                  isActive
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          {loading ? (
            <div className="py-20 flex flex-col items-center justify-center space-y-3">
              ...
              <p className="text-xs text-slate-400">Loading immutable technical passport from database...</p>
            </div>
          ) : error ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
                      <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Model Status</span>
                    ...
                    <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
                      <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Fit Diagnosis</span>
                    ...
                    <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
                      <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Generalization Gap</span>
                    ...
                    <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
                      <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Selection Score</span>
                  ...
                  <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                      <div className="space-y-1">
                        <span className="text-slate-400">Dataset Content Hash (SHA-256):</span>
                        <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 font-mono text-[11px] text-cyan-300 break-all">
                          {passport.dataset?.content_hash || passport.experiment?.dataset_content_hash || 'Unverified'}
                        </div>
                      </div>

                      <div className="space-y-1">
                        <span className="text-slate-400">Model Artifact Checksum (SHA-256):</span>
                        <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 font-mono text-[11px] text-emerald-300 break-all">
                          {passport.artifact_checksum || 'Not Serialized'}
                        </div>
                      </div>

                      <div className="space-y-1">
                        <span className="text-slate-400">Code Commit Version:</span>
                        <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 font-mono text-[11px] text-slate-200">
                          {passport.experiment?.code_version || 'HEAD'}
                        </div>
                      </div>

                      <div className="space-y-1">
                        <span className="text-slate-400">Environment Capture Method:</span>
                    ...
                    <div className="pt-2 border-t border-slate-800/80">
                      <span className="text-[11px] text-slate-400 font-semibold block mb-2">Runtime Dependency Matrix:</span>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs font-mono">
                        <div className="p-2 rounded-lg bg-slate-900/60 border border-slate-800/60">
                          ...
                          <span className="text-white">{passport.experiment?.python_version || '3.11+'}</span>
                        </div>
                        <div className="p-2 rounded-lg bg-slate-900/60 border border-slate-800/60">
                          <span className="text-slate-400">scikit-learn: </span>
                          <span className="text-white">{passport.experiment?.sklearn_version || '1.4+'}</span>
                        </div>
                        <div className="p-2 rounded-lg bg-slate-900/60 border border-slate-800/60">
                          <span className="text-slate-400">NumPy: </span>
                          <span className="text-white">{passport.experiment?.numpy_version || '1.26+'}</span>
                        </div>
                        <div className="p-2 rounded-lg bg-slate-900/60 border border-slate-800/60">
                          <span className="text-slate-400">pandas: </span>
                          <span className="text-white">{passport.experiment?.pandas_version || '2.2+'}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-3">
                    ...
                    <pre className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-xs font-mono text-cyan-200 overflow-x-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                      <div className="p-3 rounded-xl bg-slate-900 border border-slate-800">
                        ...
                        <div className="text-sm font-bold text-white font-mono mt-0.5">{passport.dataset?.row_count?.toLocaleString()}</div>
                      </div>
                      <div className="p-3 rounded-xl bg-slate-900 border border-slate-800">
                        <span className="text-slate-400">Total Columns</span>
                        <div className="text-sm font-bold text-white font-mono mt-0.5">{passport.dataset?.column_count}</div>
                      </div>
                      <div className="p-3 rounded-xl bg-slate-900 border border-slate-800">
                        <span className="text-slate-400">Dataset Version</span>
                        <div className="text-sm font-bold text-cyan-400 font-mono mt-0.5">v{passport.dataset?.version_number}</div>
                      </div>
                      <div className="p-3 rounded-xl bg-slate-900 border border-slate-800">
                  ...
                  <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-3">
                    ...
                    <div className="space-y-2 text-xs">
                      <span className="text-slate-400">Selected Features ({passport.feature_selection?.feature_count || passport.feature_selection?.final_selected_features?.length || 0}):</span>
                      <div className="flex flex-wrap gap-2">
                        {(passport.feature_selection?.final_selected_features || []).map((feat, idx) => (
                          <span
                            key={idx}
                            className="px-2.5 py-1 rounded-lg bg-slate-900 border border-slate-800 font-mono text-cyan-300 text-xs"
                          >
                            {feat}
                          </span>
                        ))}
                  ...
                  <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-3">
                    ...
                    <pre className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-xs font-mono text-emerald-200 overflow-x-auto">
                ...
                <div className="space-y-6">
                  <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-slate-400">Direct Read from <code className="text-cyan-400">model_metrics</code></span>
                    </div>
                      ...
                      <table className="w-full text-left text-xs">
                        ...
                        <tbody className="divide-y divide-slate-800 font-mono">
                          {Object.keys({
                            ...
                            return (
                              <tr key={metricName} className="hover:bg-slate-900/40">
                                <td className="px-4 py-2.5 font-bold text-white">{metricName}</td>
                                <td className="px-4 py-2.5 text-slate-300">{trainVal !== undefined ? trainVal.toFixed(4) : '—'}</td>
                                <td className="px-4 py-2.5 text-cyan-300 font-bold">{cvVal !== undefined ? cvVal.toFixed(4) : '—'}</td>
                  ...
                  <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      {passport.explainability?.has_summary ? (
                        ...
                        <span className="text-xs text-slate-400">No SHAP summary cached</span>
                      )}
                    </div>
                    ...
                    {passport.explainability?.top_features && passport.explainability.top_features.length > 0 ? (
                          ...
                          return (
                            <div key={idx} className="space-y-1 text-xs">
                              <div className="flex items-center justify-between font-mono">
                                <span className="text-slate-200 font-semibold">{featName}</span>
                                <span className="text-cyan-400">{shapVal.toFixed(5)}</span>
                              </div>
                      ...
                      <p className="text-xs text-slate-400 italic">No global SHAP explanation registered for this candidate model.</p>
                    )}
                  </div>
                </div>
              )}
                  ...
                  <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                      {(passport.governance?.gate_checks || []).map((chk, idx) => (
                        ...
                        >
                          <span className="font-mono text-slate-300">{chk.check || chk.condition_name}</span>
                          {chk.passed ? (
                  ...
                  {passport.governance?.is_deployed && (
                    <div className="p-5 rounded-2xl bg-slate-950 border border-emerald-500/30 space-y-3">
                      ...
                      <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-between text-xs font-mono">
                        <span className="text-cyan-300">{passport.governance.endpoint_url}</span>
                        <span className="text-slate-400">{new Date(passport.governance.deployed_at).toLocaleString()}</span>
                      </div>
                    </div>
                  )}
                </div>
