"""
End-to-End Test Suite: Complete Intelligent ML Studio Workflow.
Validates:
1. Authentication & Role-Based Access Control
2. Project Creation & Dataset Ingestion
3. Leakage-Safe Data Splitting (Development & Locked Test)
4. Model Training, Selection & Metrics
5. Deployment Gate & Online Inference
"""
...
def test_full_platform_e2e_api_workflow(client: TestClient):
    # 1. Health checks
