...
class ExperimentService:
    ...
    def normalize_selection_metric(
        ...
        """
        Normalizes selection metric and derives default direction via ExperimentValidator.
        """
        return ExperimentValidator.normalize_selection_metric(metric_name, task_type, direction)

    def validate_algorithms(self, task_type: str, algorithms: list[str]) -> list[str]:
        """
        Validates algorithms against supported suite via ExperimentValidator.
        """
        return ExperimentValidator.validate_algorithms(task_type, algorithms)
